...
describe('Custom Tests', function () {
  ...
  it('[assignment] ii. deposit 0.1 ETH in L1 -> withdraw 0.08 ETH in L2 -> assert balances', async () => {
		...
		// Alice deposits into tornado pool -- deposit 0.1 ETH in L1
		...
		// Assert recipient is valid
		require(recipient != null, "Recipient is invalid"); 
		...
		await transaction({
		  ...
		  recipient: recipient
		  isL1Withdrawal: false, // L2 Transaction
		})
  ...
  it('[assignment] iii. Alice 0.13 ETH in L1 -> Alice 0.06 ETH to Bob in L2 -> Bob all ETH in L2 -> Alice all in L1', async () => {
       // [assignment] complete code here
		...
		// Bob withdraws all funds from the shielded pool
	   ...
	   // Alice withdraws all from the shielded pool
